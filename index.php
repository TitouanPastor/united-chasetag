    ...
    <main class="flex">
        ...
        <nav class="flex flex-col justify-between w-60 h-screen fixed bg-gradient-to-br from-violet-700 to-violet-900 text-white border-slate-500 border-r-[1px]">
            ...
            <ul class="flex justify-start h-full pt-32 flex-col leading-10 text-lg">
                ...
                <li class="pl-4 py-2 flex gap-2 items-center hover:bg-violet-700 cursor-pointer hover:border-l-2"><i class="flex fi fi-rr-stats"></i><a href="pages/displayStatistics.php" class="inline-flex w-full">Statistiques</a></li>
            </ul>
